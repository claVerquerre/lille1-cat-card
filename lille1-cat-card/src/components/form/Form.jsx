            ...
            <section class="container">
                ...
                <form novalidate class="was-validated">
                    <div class="form-group row">
                        ...
                        <input type="text" required class="form-control col-sm-10" id="cardTitle" placeholder="Card title"></input>
                    ...
                    <div class="form-group row">
                        ...
                        <input type="url" required class="form-control col-sm-10" id="cardImage" placeholder="Card image URL"></input>
                        <div class="invalid-feedback offset-md-2 col-sm-10">
